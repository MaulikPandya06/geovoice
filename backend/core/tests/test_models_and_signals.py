...
class StatementModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.country_france = Country.objects.create(
            name="France",
            isoa3_code="FRN",
            isoa2_code="FR",
        )
...
class StatementSignalTest(TestCase):
    ...
    def setUp(self):
        ...
        # Codes are not real in all testing files
        ...
        self.country_italy = Country.objects.create(
            name="Italy",
            isoa3_code="ITL",
            isoa2_code="IL",
        )
    ...
    def test_signal_calls_embed_statement_on_create(
        self,
        mock_embed,
    ):
    ...
    @patch("core.signals.embed_statement")
    def test_signal_passes_correct_statement_to_embed(
        self,
        mock_embed,
    ):
